		...
		<div class="col-12 pt-3">
			...
			if ($es) {
				...
				switch ($cat) {
					case "industrial":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5">Línea Industrial</h2>
					...
					case "comercial":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5">Línea Comercial</h2>
					...
					case "decorativo":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5">Línea de Decorativos</h2>
					...
					case "escolar":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5">Línea Escolar</h2>
				...
				switch ($cat) {
					case "industrial":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5">Industrial Line</h2>
					...
					case "comercial":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5">Commercial Line </h2>
					...
					case "decorativo":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5"> Decorative Line </h2>
					...
					case "escolar":
						echo '
                                        <h2 class="text-danger subrayado p-2 mb-5">School Line </h2>
		...
		foreach ($data[$cat]['productos'] as $item) {
			...
			<div class="col-6 col-md-3 productos__detalle">
				<div data-toggle="modal" data-target="#exampleModalCenter" onClick="cargarDatos('<?php echo $item['descripcion'] ?>', '<?php echo $item['imagen'] ?>')">
					<img src="./subidas/th/<?php echo $item['imagen']; ?>" class="img-thumbnail shadow-sm w-100 img-fluid">
				</div>
